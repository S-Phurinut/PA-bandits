...
game_seed="setting.init_seed_id="+str(10)
...
for sim_id in range(2,6):
    ...
    process=subprocess.run(["python","run_linear_game.py",game_seed,"num_sim="+str(num_sim),"max_round="+str(max_round)
                            ,"policy=TS_aDir_cave2","reward_generator=bernoulli_cdire","setting=MABA_10CaveUni2","reward_generator.alpha=0.1"])
